...
-- Dumping structure for table sinta.dosen
...
-- Dumping data for table sinta.dosen: ~31 rows (approximately)
...
INSERT INTO `dosen` (`NIP`, `NIDN`, `NAMA`, `Alamat`, `No_hp`, `password`, `email`, `idRole`) VALUES
	...
	('197808192005012001', '0019087803', 'Ika Widiastuti, S.ST , MT', 'Jember', '123456789', '$2y$10$kH7rfnAaldA3BqYxWVUO7O/8MVMu1/GubuXYNQuhGPWHxXcRTBwGW', '', 5),
	...
	('199203022018032001', '', 'Zilvanhisna Emka Fitri ST., MT.', 'Jember', '123456789', '$2y$10$frHWrNt5OZNRTZK6HYvoie9Lpe4jq45wbh1aH22BnlKjZynmoHPHK', '', 8),
...
-- Dumping structure for table sinta.mahasiswa
CREATE TABLE IF NOT EXISTS `mahasiswa` (
  ...
  CONSTRAINT `fk_Mahasiswa_Prodi1` FOREIGN KEY (`Prodi_idProdi`) REFERENCES `prodi` (`idProdi`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table sinta.mahasiswa: ~262 rows (approximately)
...
INSERT INTO `mahasiswa` (`NIM`, `NAMA`, `Alamat`, `Tahun_masuk`, `Prodi_idProdi`, `tanggallahir`, `password`, `email`, `no_hp`) VALUES
	...
	('E41179002', 'Himawari', 'Konohagakure', '2017', 3, '1998-08-11', '$2y$10$T/bRLCtW5sAoZcqYdzUzUOlTx9ExW/HQ6RlPuNkSIGQWlf.rIuCNG', 'admin@gmail.com', ''),
	('E4172054', 'Taufikur Rahman', NULL, '2017', 1, NULL, '$2y$10$GfYeD8uLnYVakB6l5dCqR.wdZbR3mRcv8N0Z7KxP3VhBYkA7A0v0i', '', '');
/*!40000 ALTER TABLE `mahasiswa` ENABLE KEYS */;

-- Dumping structure for table sinta.master_status
...
-- Dumping data for table sinta.master_status: ~8 rows (approximately)
...
-- Dumping structure for table sinta.prodi
CREATE TABLE IF NOT EXISTS `prodi` (
  `idProdi` int(2) NOT NULL AUTO_INCREMENT,
  `Nama_prodi` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idProdi`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- Dumping data for table sinta.prodi: ~3 rows (approximately)
...
-- Dumping structure for table sinta.role
...
-- Dumping data for table sinta.role: ~12 rows (approximately)
...
-- Dumping structure for table sinta.ruangan
CREATE TABLE IF NOT EXISTS `ruangan` (
  `idRuangan` int(3) NOT NULL AUTO_INCREMENT,
  `Nama_ruangan` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idRuangan`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- Dumping data for table sinta.ruangan: ~0 rows (approximately)
/*!40000 ALTER TABLE `ruangan` DISABLE KEYS */;
INSERT INTO `ruangan` (`idRuangan`, `Nama_ruangan`) VALUES
	(1, '3.3');
/*!40000 ALTER TABLE `ruangan` ENABLE KEYS */;

-- Dumping structure for table sinta.status_ta
...
-- Dumping data for table sinta.status_ta: ~11 rows (approximately)
...
-- Dumping structure for table sinta.td_bimbingan
CREATE TABLE IF NOT EXISTS `td_bimbingan` (
  `id_bimbingan` int(9) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table sinta.td_bimbingan: ~2 rows (approximately)
/*!40000 ALTER TABLE `td_bimbingan` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `td_bimbingan` ENABLE KEYS */;
...
/*!40000 ALTER TABLE `td_seminar` ENABLE KEYS */;

-- Dumping structure for table sinta.td_sidang
CREATE TABLE IF NOT EXISTS `td_sidang` (
  `id_sidang` int(6) NOT NULL AUTO_INCREMENT,
  ...
  KEY `NIP_Anggota` (`NIP_Anggota`),
  KEY `id_TA` (`id_TA`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- Dumping data for table sinta.td_sidang: ~2 rows (approximately)
/*!40000 ALTER TABLE `td_sidang` DISABLE KEYS */;
INSERT INTO `td_sidang` (`id_sidang`, `Nilai_panelis`, `Nilai_anggota`, `Nilai_sidang`, `Nilai_bimbingan`, `Tanggal`, `jam`, `id_TA`, `NIP_Anggota`, `id_status`, `idruangan`) VALUES
	...
	(3, NULL, 0, 0, 0, '2021-12-12', '00:12:00', 107, NULL, NULL, NULL);
/*!40000 ALTER TABLE `td_sidang` ENABLE KEYS */;

-- Dumping structure for table sinta.topik
CREATE TABLE IF NOT EXISTS `topik` (
  `idTopik` int(3) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table sinta.topik: ~12 rows (approximately)
...
-- Dumping structure for table sinta.tugas_akhir
...
-- Dumping data for table sinta.tugas_akhir: ~105 rows (approximately)
...
INSERT INTO `tugas_akhir` (`id`, `Judul_TA`, `Deskripsi`, `abstract`, `keywords`, `Dosen_NIP`, `Mahasiswa_NIM`, `id_status`, `id_topik`, `tgl_ACC`, `tgl_pengajuan`, `status`) VALUES
	(1, 'CCTV otomatis menggunakan hp cetol', 'Polijesip', 'polije ashiap', 'robot', '198101152005011011', 'E41171892', 4, 5, NULL, '2020-10-28', ''),
	...
	(107, 'Teknik Ninja Medis Menggunakan Metode FIve Pl', 'Deskripsi Teknik Ninja Medis Menggunakan Metode FIve Planes of UX', 'Abstrak Teknik Ninja Medis Menggunakan Metode FIve Planes of UX', 'UX, UI, Desain', '199205282018032001', 'E41179002', 2, 12, '2020-12-06', '2020-12-06', '');
