							...
							<td class="text-center">
								<div class="dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
										...
										<a href="<?php echo base_url() . 'Penentuan_tanggal_seminar/delete/' . $i->id_seminar; ?>" class="dropdown-item confirm">Delete</a>
									</div>
								</div>
							</td>
						</tr>
	...
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body f-15 my-3">
				<form action="Penentuan_tanggal_seminar/update" method="post" id="formValidasi">
