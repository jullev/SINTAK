							...
							<td class="text-center">
								<div class="dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
										...
										<!-- <a href="<?php echo base_url() . 'Penentuan_tanggal_sidang/edit/' . $i->id_sidang; ?>" class="dropdown-item" )">Edit</a> -->
										<a href="<?php echo base_url() . 'Penentuan_tanggal_sidang/delete/' . $i->id_sidang; ?>" class="dropdown-item" onclick="return confirm('Anda Yakin Menghapus Data?')">Delete</a>
									</div>
								</div>
							</td>
						</tr>
