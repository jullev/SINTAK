        ...
        <form method="POST" action="<?php echo base_url().'Dosen/update_action' ?>">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    <label>NIP</label>
                    <input type="text" class="form-control form-control-sm" name="NIP" placeholder="Masukkan NIP" value="<?php echo $data->NIP; ?>" required>
                    <div class="text-danger ml-1 mt-1"><?php echo $validation_NIP; ?></div>
                </div>
                <div class="col-md-6 form-group">
                    <label>NIDN</label>
                    <input type="text" class="form-control form-control-sm" name="NIDN" placeholder="Masukkan NIDN" value="<?php echo $data->NIDN; ?>" required>
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    <label>Nama</label>
                    <input type="text" class="form-control form-control-sm" name="NAMA" placeholder="Masukkan Nama" value="<?php echo $data->NAMA; ?>" required>
                    <div class="text-danger ml-1 mt-1"><?php echo $validation_NAMA; ?></div>
                </div>
                <div class="col-md-6 form-group">
                    <label>Alamat</label>
                    <textarea class="form-control form-control-sm" name="Alamat" required><?php echo $data->Alamat; ?> </textarea>
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    <label>No.HP</label>
                    <input type="text" class="form-control form-control-sm" name="No_hp" placeholder="Masukkan No. HP (08xxxxxxxxxx)" value="<?php echo $data->No_hp; ?>" required>
