...
INSERT INTO `dosen` (`NIP`, `NIDN`, `NAMA`, `Alamat`, `No_hp`, `password`, `idRole`) VALUES
...
('197810112005012002', '0011107802', 'Elly Antika, ST, M.Kom', 'Jember', '123456789', '$2y$10$NLekdmqo7EjLqvgfK8B1aesQqo7p2XgInfVRihEOs4KMZqiEiMvKy', 2),
('197909212005011001', '0021097903', 'I Putu Dody Lesmana, ST,MT', 'Jember', '123456789', '$2y$10$WlCBELecPidXd6u9a7t6wezZqcCYvSoek8/r7ETVZ.79pPga7jNym', 2),
...
('198012122005011001', '0012128001', 'Prawidya Destarianto , S.Kom ,MT', 'Jember', '123456789', '$2y$10$QlKfKi7ZNHK/PZRe3T0enevuu4HrRvRIogQ2.wW3VBymjPOfUfJvC', 2),
...
('198511282008121002', '0028118502', 'Aji Seto Arfianto, S.ST, MT', 'Jember', '123456789', '$2y$10$MWlm1IazMU6.BpGzssGdc.e27SttNevyVaE1thBwm7SfLNG/UlQw.', 2),
...
('198608022015042002', '0702088601', 'Ratih Ayuninghemi S.ST, M.Kom', 'Jember', '123456789', '$2y$10$F8Hc9K4vmIgqJ3Hfhq69Ee8IdPE2e2njHP2HwAz31eMcn2a69cxJy', 2),
...
INSERT INTO `mahasiswa` (`NIM`, `NAMA`, `Alamat`, `Tahun_masuk`, `Prodi_idProdi`, `tanggallahir`, `password`) VALUES
...
INSERT INTO `td_sidang` (`id_sidang`, `Nilai`, `Tanggal`, `jam`, `id_TA`, `NIP_Panelis`, `id_status`, `idruangan`) VALUES
(2, 22, '2020-03-29', '15:00:00', 1, '197110092003121001', 4, 1);
...
,`Judul_TA` varchar(45)
,`NAMA` varchar(45)
,`Mahasiswa_NIM` varchar(9)
,`dosen_pembimbing` varchar(45)
,`dosen_panelis` varchar(45)
,`Status` varchar(45)
